...
If the VR headset is not responding correctly, restarting it can often fix the issue.  
This will close all running applications and start the headset again.

Restarting does **not remove any data or training progress**.
