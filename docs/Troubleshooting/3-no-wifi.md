...
<div style="text-align: center">
    <img src="/assets/wifi-box-select.png" style="width: 500px;">
</div>
...
<div style="text-align: center">
    <img src="/assets/wifi-settings.png" style="width: 500px;">
</div>
...
Once both the **case** and the **headset** are connected to **VRCase**, start the training application again.  The **headset** and **Spectator** should now connect normally. If you still don't have Wi-Fi, you will need to connect the box and headset to your own network. You can do this by going to the settings explained above, and selecting your own network instead.
