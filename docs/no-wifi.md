...
If the **Spectator** or the **headset** shows a **No Wi-Fi** popup, follow the steps below to reconnect.

---

## If the popup appears in the Spectator
...
![Clean image of wifi icon on case in taskbar](../assets/example.png)
...
Once both the **case** and the **headset** are connected to **VRCase**, start the training application again.

The **headset** and **Spectator** should now connect normally.